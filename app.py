...
def load_all_data_v2():
    ...
    eval_metrics_df = pd.DataFrame({
        ...
        "Precision@5": [0.0052, 0.0049, 0.0053, 0.0060],
        "Recall@5": [0.0140, 0.0135, 0.0144, 0.0160],
        "F1@5": [0.0074, 0.0070, 0.0076, 0.0086],
        "HR@5": [0.0261, 0.0245, 0.0267, 0.0301],
        "NDCG@5": [0.0098, 0.0094, 0.0101, 0.0123],
        "RMSE": [0.2882, 0.3475, 0.2958, 0.3063],
        "MAE": [0.2478, 0.2852, 0.2521, 0.2585],
        "Accuracy": [0.9038, 0.8774, 0.9016, 0.8961],
        "Class F1-Score": [0.9486, 0.9322, 0.9473, 0.9437]
    })
